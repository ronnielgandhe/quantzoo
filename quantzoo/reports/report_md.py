...
{_format_walkforward_results(metrics)}

## Equity Curve

{f'![Equity Curve](reports/{plot_path})' if plot_path else '*No equity curve data available*'}

## Risk Metrics

- **Sharpe Ratio:** {metrics.get('sharpe_ratio', 0):.3f} (Risk-adjusted return)
